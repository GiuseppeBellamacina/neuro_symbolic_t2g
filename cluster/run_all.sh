...
for arg in "$@"; do
    case "$arg" in
        ...
        --help|-h)
            ...
            echo "  ablations/rewards/lean-stack          Stack reward a 4 componenti (no verifier/bleu/format)"
            ...
            echo "  ablations/objectives/sft-structured-shuffled  Controllo GATE 2 (transizioni shuffled)"
