...
\begin{description}
  ...
  \item[Pass@$k$.] Probabilità che almeno una fra $k$ generazioni indipendenti
        superi una soglia di correttezza. Dato che su $n$ campioni si osservano
        $c$ successi, lo stimatore non distorto è
        \begin{equation}
          \label{eq:passk}
