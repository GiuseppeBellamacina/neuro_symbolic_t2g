...
Va dichiarato infine lo stato della suite di test: un test dipende da una
connessione di rete verso il cluster e il suo esito varia con l'ambiente di
esecuzione, non con il codice (Capitolo~\ref{cap:codebase}).
