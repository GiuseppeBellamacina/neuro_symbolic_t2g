...
\midrule
ROUGE-L & $0{,}9685$ & $0{,}9752$ & $+0{,}0067$ \\
Exact match & $0{,}5865$ & $0{,}8130$ & $+0{,}2265$ \\
...
\midrule
ROUGE-L: $+0{,}0067$ & $[+0{,}0038,\; +0{,}0098]$ \\
Exact match: $+0{,}2265$ & $[+0{,}2025,\; +0{,}2510]$ \\
\bottomrule
\end{tabular}
\end{center}

Entrambi gli intervalli escludono lo zero: il vantaggio dell'SFT è
statisticamente solido. Ma la sua \emph{grandezza} dipende radicalmente dalla
metrica:

\begin{itemize}
  \item su ROUGE-L il guadagno è $+0{,}0067$, cioè lo $0{,}7\%$ assoluto. Un
        modello addestrato su $73$ mila esempi guadagna meno di un punto
        percentuale su una tabella di corrispondenze;
  \item su exact match il guadagno è $+0{,}2265$, cioè un abbattimento del tasso
        di errore dal $41{,}4\%$ al $18{,}8\%$. In termini di errore relativo è
        una riduzione di circa il $55\%$.
\end{itemize}
...
Il ROUGE-L dell'SFT è $0{,}9752$. Il miglior valore pubblicato in letteratura su
...
learning possa colmare}. Con exact match $0{,}8130$ e validity $0{,}9998$, un
